...
def save_chat(request):
    if request.method == 'POST':
        chat_data = json.loads(request.body.decode('utf-8'))['chat_data']
        print(chat_data)
         # Assuming the chat data is sent as a POST parameter named 'chat_data'

        # Connect to MongoDB
        client = MongoClient('mongodb://localhost:27017/')
        db = client['Healthbot']  # Replace 'your_database' with your actual MongoDB database name
        collection = db['Chats Data']  # Replace 'chat_data' with your desired collection name

        # Insert the chat data into MongoDB
        result = collection.insert_one({'chat_data': chat_data})
